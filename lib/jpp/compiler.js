  ...
  for (const stmt of ast.body) {
    switch (stmt.type) {
      case 'Declaration':
        ...
        typeChecker.checkDeclaration(stmt.name, stmt.value, stmt.line, stmt.col);
        break;
      case 'Assignment':
        typeChecker.checkAssignment(stmt.name, stmt.value, stmt.line, stmt.col);
        break;
      case 'PrintStatement':
        typeChecker.checkExpression(stmt.value);
        break;
      ...
      case 'ForStatement':
        ...
        typeChecker.symbols.set(stmt.variable, {
          type: 'number',
...
module.exports.compileJPlusPlus = compileJPlusPlus;
