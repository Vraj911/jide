...
class TypeChecker {
  ...
  /**
   * Get variable information for LSP
   * @param {string} name - Variable name
   * @returns {Object|null} Variable info with type
   */
  ...
  /**
   * Get all variables for LSP completions
   * @returns {Map} Map of variable names to types
   */
  getVariables() {
    return new Map(this.symbols);
  }
